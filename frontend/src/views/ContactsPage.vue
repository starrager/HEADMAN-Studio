        ...
        <main>
            <section class="contacts-hero">
                <div class="container">
                    ...
                    <p>
                        Приходите в студию, звоните нам или оставляйте заявку.
                        Всегда рады новым и постоянным клиентам.
                    </p>
                </div>
            </section>
                ...
                <div class="container">
                    <div class="contacts__grid">
                        <div class="contacts__info">
                            ...
                            <div class="contact-item">
                                <span>03 / ПОЧТА</span>
                                <h3>INFO@HEADMAN.RU</h3>
                                <p>ОТВЕТИМ В ТЕЧЕНИЕ ДНЯ</p>
                            </div>
                            <div class="contact-item">
                                <span>04 / СОЦИАЛЬНЫЕ СЕТИ</span>
                                <div class="socials">
                                    <a href="#">VK</a>
                                    <a href="#">TG</a>
                                    <a href="#">INST</a>
...
.socials a{
    ...
    width:70px;
    height:45px;
    border:1px solid rgba(220,185,116,.35);
    color:#dcb974;
    font-size:9px;
    font-weight:700;
...
.map{
    ...
    overflow:hidden;
    background:#1c1913;
    border:1px solid rgba(220,185,116,.3);
}
.map__grid{
    position:absolute;
    inset:0;
    background-image:linear-gradient(rgba(220,185,116,.07) 1px,transparent 1px),linear-gradient(90deg,rgba(220,185,116,.07) 1px,transparent 1px);
...
.schedule__inner>div:first-child>span{
    color:#dcb974;
    font-size:9px;
    font-weight:700;
    letter-spacing:3px;
