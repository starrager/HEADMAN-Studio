    ...
    <div class="services-page">
        <section class="services-hero">
            <div class="container">
                ...
                <p>
                    Стрижки, борода, уход и полный мужской образ.
                    Выбирай услугу — остальное сделаем мы.
                </p>
            </div>
        </section>
...
.header{
    position:relative;
    z-index:10;
    border-bottom:1px solid rgba(220,185,116,0.25);
}
.header-inner{
    min-height:90px;
    display:flex;
...
.service-list{
    border-top:1px solid rgba(220,185,116,0.4);
}
.service-item{
    position:relative;
    min-height:105px;
...
.service-item::before{
    ...
    top:0;
    bottom:0;
    background:rgba(220,185,116,0.035);
    opacity:0;
...
.combo-item .service-meta{
    gap:18px;
}
.combo-item .service-meta small{
    color:#dcb974;
    font-size:10px;
    font-weight:600;
    white-space:nowrap;
...
.vip-section .service-list{
    border-top-color:#dcb974;
}
.vip-item{
    min-height:120px;
}
.vip-item .service-main h3{
    font-size:31px;
}
.vip-item .service-meta strong{
    font-size:31px;
}
.services-cta{
    position:relative;
